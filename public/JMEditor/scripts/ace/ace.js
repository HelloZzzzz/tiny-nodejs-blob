(function () {
    ...
    function o(e, t, n) {
        ...
        if (!i.isMac && u) {
            ...
            if (n === 18 || n === 17) {
                ...
                if (n === 17 && f === 1) u[n] == 1 && (a = t.timeStamp); else if (n === 18 && o === 3 && f === 2) {
                    var l = t.timeStamp - a;
                    l < 50 && (u.altGr = !0)
                }
            }
    ...
    (function () {
        r.implement(this, d), this.$initOperationListeners = function () {
            ...
            if (!this.inMultiSelectMode || this.inVirtualSelectionMode) this.insert(e); else {
    ...
    function o(e) {
        ...
        if (l.$mouseHandler.$enableJumpToDef) u && n || a && n ? S = "add" : n && l.$blockSelectEnabled && (S = "block"); else if (a && !n) {
            S = "add";
            if (!h && o) return
